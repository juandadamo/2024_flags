...
U = Velocidad - Uc
ax.plot(Velocidad,Amplitud,marker='s',fillstyle='none',linestyle='none',markeredgewidth=1.5,markersize=10)
ax.set_xlabel('$U$[m/s]')
ax.set_ylabel('$A/L$')
ax.grid()
...
ax.set_ylim([0,0.8])
fig.tight_layout()
# fig.savefig(dirw+'Amplitudes_global_'+caso+'.png',dpi=300, bbox_inches='tight')
...
ax.plot(Velocidad,Amplitud,marker='o',fillstyle='none',linestyle='none',markeredgewidth=1.5,markersize=10)
# fig.savefig(dirw+'Amplitudes_global_'+caso+'.png',dpi=300, bbox_inches='tight')
...
ax.plot(Velocidad,Amplitud,marker='>',fillstyle='none',linestyle='none',markeredgewidth=1.5,markersize=10)
# fig.savefig(dirw+'Amplitudes_global_'+caso+'.png',dpi=300,bbox_inches='tight')