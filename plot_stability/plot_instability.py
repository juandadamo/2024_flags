...
plt.close('all')
R1 = pd.read_csv('raynaud_black.csv',header=None).to_numpy().T
R2 = pd.read_csv('raynaud_orange.csv',header=None).to_numpy().T
R3 = pd.read_csv('raynaud_yellow.csv',header=None).to_numpy().T

A1 = pd.read_csv('argentina.csv',header=None).to_numpy().T
S1 = pd.read_csv('shelley.csv',header=None).to_numpy().T
E1 = pd.read_csv('eloy_black.csv',header=None).to_numpy().T
E2 = pd.read_csv('eloy_gray1.csv',header=None).to_numpy().T
E3 = pd.read_csv('eloy_gray2.csv',header=None).to_numpy().T
...
ax.plot(R2[0],R2[1],marker='s',linestyle='none',markersize=10,fillstyle='none',label='1',markeredgewidth=2)
